...
CREATE TABLE IF NOT EXISTS guildconfig (
  ...
  timeReportChannelId VARCHAR(64) DEFAULT NULL,
  lastTimeReportOn DATE DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS scheduledmeeting (
  ...
  voiceChannelId VARCHAR(64) DEFAULT NULL,
  projectId VARCHAR(36) DEFAULT NULL,
  recordingEnabled BOOLEAN DEFAULT FALSE,
  autoChannelId VARCHAR(64) DEFAULT NULL,
  channelCreatedAt DATETIME(3) DEFAULT NULL,
